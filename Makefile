...
liba_glibc_rtld_audit_shared_lib.so.1.0.1: a_glibc_rtld_audit_shared_lib.c  module_strcat_descript_number.c
	$(CC) -fPIC -c  $(CFLAGS) -o  a_glibc_rtld_audit_shared_lib.o  a_glibc_rtld_audit_shared_lib.c
	$(CC) -fPIC -c  $(CFLAGS) -o  module_strcat_descript_number.o  module_strcat_descript_number.c
	$(CC) -shared   $(LDFLAGS) -Wl,-soname,liba_glibc_rtld_audit_shared_lib.so.1 -o liba_glibc_rtld_audit_shared_lib.so.1.0.1 a_glibc_rtld_audit_shared_lib.o module_strcat_descript_number.o -lc  -ldl  -lunwind 
...
clean:
	-rm -f a_test  a_test.o  a_glibc_rtld_audit_shared_lib.o   liba_glibc_rtld_audit_shared_lib.so.1.0.1 shared_library_declared_at_compiling_time.o  libshared_library_declared_at_compiling_time.so   shared_library_dynamic_loading.o   libshared_library_dynamic_loading.so module_strcat_descript_number.o  unit_tests_strcat_descript_number
...
unit_tests: unit_tests_strcat_descript_number.c module_strcat_descript_number.c
	...
	$(CC) -c  $(CFLAGS) -o  module_strcat_descript_number.o  module_strcat_descript_number.c
	$(CC) -o unit_tests_strcat_descript_number   unit_tests_strcat_descript_number.c   module_strcat_descript_number.o
